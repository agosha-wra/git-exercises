...
describe 'The Git Repository' do
  ...
  it 'should have a master branch with everything in feature-3 to feature-3a' do
    expect(@g.branch('master').contains?('feature-3a')).to be true
    expect(@g.branch('master').contains?('feature-3')).to be true
  end

  it 'should have a master branch with everything in feature-1 to feature-1b' do
  ...
  it 'should have a master branch with everything in feature-2 to feature-2a' do
